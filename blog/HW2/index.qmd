...
- \(\beta = +0.00005022\)  
- \(\exp(0.00005022)\approx1.0000502\)  
...
- **Private room**: \(\beta=-0.1531\) → \(\exp(-0.1531)\approx0.858\) ⇒ **14.2% fewer** reviews  
- **Shared room**: \(\beta=-0.4080\) → \(\exp(-0.4080)\approx0.665\) ⇒ **33.5% fewer** reviews
